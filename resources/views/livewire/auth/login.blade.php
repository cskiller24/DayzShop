<div class="page page-center bg-dark">
    <div class="container container-tight py-4">
                ...
                <form wire:submit="login">
                    ...
                    <div class="mb-2">
                        <div class="d-flex justify-content-between">
                            ...
                            <x-base::link href="{{ route('password.request') }}" wire:navigate>Forgot Password
                            </x-base::link>
                        </div>
                        <x-base::text-input placeholder="Enter your password" type="password" wire:model="password"
                                            errorKey="password"/>
        ...
        <div class="text-center text-light mt-3">
            ...
            <x-base::link href="{{ route('register') }}" wire:navigate>Sign up</x-base::link>
        </div>
    </div>
</div>
